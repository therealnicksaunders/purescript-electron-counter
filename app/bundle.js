...
(function(exports) {
  ...
  var serialize = function (v) {
      ...
      throw new Error("Failed pattern match at Component.App line 57, column 1 - line 57, column 29: " + [ v.constructor.name ]);
  };
  var render = function (state) {
      return Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(Increment.create)) ])([ Halogen_HTML_Core.text(Data_Show.show(Data_Maybe.showMaybe(Data_Show.showInt))(state)) ]);
  };
  ...
  var increment = function (v) {
      ...
      throw new Error("Failed pattern match at Component.App line 53, column 1 - line 53, column 28: " + [ v.constructor.name ]);
  };
  var deserialize = function (v) {
      if (v === "") {
          return Data_Maybe.Nothing.value;
      };
      return Data_Int.fromString(v);
  };
  var $$eval = function (v) {
      if (v instanceof Initialize) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(Node_FS_Aff.readTextFile(Node_Encoding.UTF8.value)("count.txt")))(function (v1) {
              var state = deserialize(v1);
      ...
      if (v instanceof Increment) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
              var nextState = increment(v1);
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(Node_FS_Aff.writeTextFile(Node_Encoding.UTF8.value)("count.txt")(serialize(nextState))))(function () {
      ...
      throw new Error("Failed pattern match at Component.App line 40, column 1 - line 40, column 83: " + [ v.constructor.name ]);
  };
...
(function(exports) {
  ...
  var Node_FS = PS["Node.FS"];
  var Prelude = PS["Prelude"];        
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(Halogen_VDom_Driver.runUI(Component_App.component)(Data_Unit.unit)));
  exports["main"] = main;
})(PS["Main"] = PS["Main"] || {});
PS["Main"].main();
